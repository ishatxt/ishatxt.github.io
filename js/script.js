...
console.log(
  "%c emelecollab.com",
  "font-family:Arial, sans-serif; font-weight:600; color:#fff; background: #000; font-size:15px; text-transform: uppercase; padding: 20px 30px;",
);
